    ...
    def _checkStarted(self):
        for comm in self.comms:
            if not comm.remote.salinfo.started:
                ...
                self.showMessage(f"{state} {time.monotonic() - self._startTime:.1f}s")
                return
