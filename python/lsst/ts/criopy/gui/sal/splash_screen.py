...
class SplashScreen(QSplashScreen):
    ...
    *comms_args : `[str, ]`
    ...
    @dataclass
    class CommArgs:
        """Holds arguments for creating SAl/DDS connection."""

        name: str
        manual: dict[str, Any] | None
        kwargs: dict[str, Any]

    def __init__(self, *comms_args: CommArgs, show: bool = True):
        self.comms_args = comms_args
        self.comms: list[MetaSAL] = []
        self._show = show
        self.state = 0
        ...
        self._check_timer.timeout.connect(self._checkStarted)
        self._check_timer.start(100 if self._show else 1000)
